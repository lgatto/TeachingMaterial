...
This gives several compiler errors in `merman.cpp` when compiled on [Bio-Linux 8](http://environmentalomics.org/whats-new-in-bio-linux-8/) / [Ubuntu 14.04 LTS](http://releases.ubuntu.com/14.04/) using GCC 4.8.2 and also on OS X Mavericks (10.9) using XCode with GCC 4.2.1.
