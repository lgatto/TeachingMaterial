...
we will have to use an older version of R: version 2.15.x.


```r
# Install old derfinder and dependencies
source("http://bioconductor.org/biocLite.R")
biocLite(c("Genominator", "limma", "HiddenMarkov", "locfdr", "RSQLite.extfuns"))
install.packages("devtools")
library(devtools)
...
Also, there are some "rda" files to be loaded with the sample code that are not provided in the Github repo. And there may be [other issues](https://github.com/alyssafrazee/derfinder/issues)...
