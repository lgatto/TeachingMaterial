...
\begin{frame}
  ...
  \begin{quote}
    ...
    totyping in R is often cost effective. And in our experience very few routines
    ...
    enhancements of the code will require someone that is proficient in both R
