...
You can also create your own data types (classes). Lets says we want to
wrap two pieces of information: - DNA sequence name - DNA sequence
...
code, e.g. plot a pie chart of the distribution of DNA letters.
