...
You can also create your own data types (classes). Lets says we want to wrap two pieces of information:
- DNA sequence name
- DNA sequence  
...
Calling `plot()` on our data doesn't work. Create your own implementation of `plot()` for `MyDNASeq`. You can put any meaningful code, e.g. plot a pie chart of the distribution of DNA letters.  
