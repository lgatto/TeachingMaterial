...
```
## in method for 'name' with signature '"GenericSeq"': no definition for class "GenericSeq"
```
...
```
## in method for 'name<-' with signature 'object="GenericSeq",value="character"': no definition for class "GenericSeq"
```
...
```
## in method for 'sequence' with signature '"GenericSeq"': no definition for class "GenericSeq"
```
...
```
## in method for 'sequence<-' with signature 'object="GenericSeq",value="character"': no definition for class "GenericSeq"
```
...
```
## Error in (function (cl, name, valueClass) : 'validity' is not a slot in class "NULL"
```
...
```
## Error in getClass("GenericSeq"): "GenericSeq" is not a defined class
```
...
```
## in method for 'show' with signature '"GenericSeq"': no definition for class "GenericSeq"
```
...
```
## in method for '[' with signature '"GenericSeq"': no definition for class "GenericSeq"
```
...
```
## Error in reconcilePropertiesAndPrototype(name, slots, prototype, superClasses, : no definition was found for superclass "GenericSeq" in the specification of class "DNASeq"
```
...
```
## Error in getClass(Class, where = topenv(parent.frame())): "DNASeq" is not a defined class
```
