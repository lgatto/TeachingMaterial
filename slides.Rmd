...
Slides: http://bit.ly/qprotda -- [all material](https://github.com/lgatto/Quantitative-Proteomics-and-Data-Analysis)
...
* Learning curve (although, I would argue that the reflection about
the data and analysis is the really challenging part)
...
* **Data** Ratios or intenstities - do not let the software decide for you!
...
- see NOTES
- see *Statistics primer* practical
- MA plots
