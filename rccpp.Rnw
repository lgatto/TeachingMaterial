...
\begin{frame}{References}
  \begin{block}{Further reading}
    ...
    \item Dirk Eddelbuettel, Seamless {R} and {C++} Integration with {Rcpp}, Springer, 2013.
    \item Dirk Eddelbuettel and Romain Francois, \textit{Rcpp: Seamless R and C++ Integration}, 
